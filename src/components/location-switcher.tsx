...
export function LocationSwitcher() {
  ...
  return (
    <div ref={ref} className="relative flex items-center gap-3">
      <a
        href={loc.phoneHref}
        className="hidden items-center gap-1.5 text-sm font-medium text-gray-700 transition-colors hover:text-blue-900 xl:flex"
      >
        ...
        <span className="tabular-nums">{loc.phoneDisplay}</span>
      </a>
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
