...
export const LOCATIONS: Record<LocationSlug, ClinicLocation> = {
  "new-york": {
    ...
    geo: { lat: 40.7685149, lng: -73.9619824 },
    mapUrl:
      "https://maps.app.goo.gl/zXpLeBjbTz3nxWUU7",
    mapEmbed:
      "https://www.google.com/maps?q=184+E+70th+St,+New+York,+NY+10021&output=embed",
    tagline: "Our Upper East Side concierge clinic.",
  },
  "salt-lake-city": {
    slug: "salt-lake-city",
